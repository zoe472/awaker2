...
ユーザーとブランドの架け橋になることのできるサイトを目指し作成いたしました。
...
## 課題と今後実装したい機能
#### 投稿詳細画面のview。  
 広告としてはデザイン性にかけるため、写真や文字の表示方法などデザイン面の改良が必要  
 
#### 情報編集機能の実装    
 ユーザーアイコンや投稿情報の編集機能を実装したいと考えています。  
 管理ユーザーの管理画面ではカテゴリまで自由に編集できるようにしたいと思います。  
 
#### ブランドごとのマイページの実装  
 ユーザーだけでなく、ブランドごとにもマイページをもうけ
 ユーザーが製品の特集ページを組めたり、お知らせを載せられるようにしたいと考えております。
